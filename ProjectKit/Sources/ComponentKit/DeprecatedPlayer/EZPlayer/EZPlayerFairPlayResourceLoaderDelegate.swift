...
class EZPlayerFairPlayResourceLoaderDelegate: EZPlayerAVAssetResourceLoaderDelegate {
  ...
  override var customScheme: String {
    return "skd"
  }
  
  //Returns the Application Certificate needed to generate the Server Playback Context message.
  var fetchApplicationCertificate: (() -> Data?)?
  
  var contentKeyFromKeyServerModuleWithSPCData: ((_ spcData: Data, _ assetIDString: String) -> Data?)?
  
  
  let assetIdentifier: String
  
  init(asset: AVURLAsset, assetIdentifier: String) {
  ...
  @discardableResult func deletePersistedConentKeyForAsset() throws -> Bool {
  ...
  //    /// Returns the Application Certificate needed to generate the Server Playback Context message.
  //    func fetchApplicationCertificate() -> Data? {
  //
  ...
  //    }
  //
  //    func contentKeyFromKeyServerModuleWithSPCData(spcData: Data, assetIDString: String) -> Data? {
  //
  //        // MARK: ADAPT: YOU MUST IMPLEMENT THIS METHOD.
