...
/// 动画时间
var ezAnimatedDuration = 0.3

let EZPlayerErrorDomain = "EZPlayerErrorDomain"
...
func toNSError(code: Int, userInfo dict: [AnyHashable : Any]? = nil) -> NSError
{
...
///   - rhs: 右值
/// - Returns: 比较结果
func ==(lhs: EZPlayerState, rhs: EZPlayerState) -> Bool {
  switch (lhs, rhs) {
...
class EZPlayerUtils{
  ...
  /// system volume ui
  static let systemVolumeSlider : UISlider = {
  ...
  static func formatTime( position: TimeInterval,duration:TimeInterval) -> String{
