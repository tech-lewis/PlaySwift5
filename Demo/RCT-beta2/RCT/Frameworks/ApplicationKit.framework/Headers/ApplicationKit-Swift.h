...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ApplicationKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC14ApplicationKit21ActivityIndicatorView")
...
SWIFT_CLASS("_TtC14ApplicationKit15AlignmentLayout")
@interface AlignmentLayout : UICollectionViewFlowLayout
...
SWIFT_CLASS("_TtC14ApplicationKit16CollectionServer")
@interface CollectionServer : NSObject
...
@interface CollectionServer (SWIFT_EXTENSION(ApplicationKit)) <UICollectionViewDelegate>
...
@interface CollectionServer (SWIFT_EXTENSION(ApplicationKit)) <UICollectionViewDataSource>
...
@interface CollectionServer (SWIFT_EXTENSION(ApplicationKit)) <UICollectionViewDelegateFlowLayout>
...
@interface CollectionServer (SWIFT_EXTENSION(ApplicationKit)) <UIScrollViewDelegate>
...
SWIFT_CLASS("_TtC14ApplicationKit18ESRefreshComponent")
...
@interface ESRefreshComponent (SWIFT_EXTENSION(ApplicationKit))
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
@end


SWIFT_CLASS("_TtC14ApplicationKit23ESRefreshFooterAnimator")
...
SWIFT_CLASS("_TtC14ApplicationKit19ESRefreshFooterView")
...
SWIFT_CLASS("_TtC14ApplicationKit23ESRefreshHeaderAnimator")
...
SWIFT_CLASS("_TtC14ApplicationKit19ESRefreshHeaderView")
...
SWIFT_CLASS("_TtC14ApplicationKit14NavigationView")
...
SWIFT_CLASS("_TtC14ApplicationKit15PlaceholderView")
...
SWIFT_CLASS("_TtC14ApplicationKit11TableServer")
@interface TableServer : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@interface TableServer (SWIFT_EXTENSION(ApplicationKit)) <UITableViewDataSource>
...
@interface TableServer (SWIFT_EXTENSION(ApplicationKit)) <UIScrollViewDelegate>
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
- (void)scrollViewDidZoom:(UIScrollView * _Nonnull)scrollView;
- (void)scrollViewWillBeginDragging:(UIScrollView * _Nonnull)scrollView;
- (void)scrollViewWillEndDragging:(UIScrollView * _Nonnull)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(CGPoint * _Nonnull)targetContentOffset;
...
@interface TableServer (SWIFT_EXTENSION(ApplicationKit)) <UITableViewDelegate>
